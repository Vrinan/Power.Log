            ...
            that.gridPageLoad(dataparams, function (data) {
                ...
                if (data.success) {
                    ...
                    if (thisTableConfig.render && typeof thisTableConfig.render == "function") {
                        ...
                        // configListMap[keyword] = Util.deepClone(thisTableConfig);
                        // that.setData("configListMap", configListMap);

                        var configListMapNew = that.getData("configListMap");
                        configListMapNew[keyword] = configListMap[keyword];
                        that.setData("configListMap", configListMapNew);
