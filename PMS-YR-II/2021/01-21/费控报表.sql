...
--合同
select sum(FinalSubContractAmount) as Amount from PS_CM_SubContract where status = 50 and SubContractType in('E','P','C','S') and EpsProjId='22499ebc-401c-44e1-a036-6134dd424d8d'