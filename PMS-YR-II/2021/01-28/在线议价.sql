...
update XLX_PUR_InquiryOnline set status = 0


alter table XLX_PUR_InquiryOnlineDoc add RegHumId uniqueidentifier null
alter table XLX_PUR_InquiryOnlineDoc add RegHumName nvarchar(max) null