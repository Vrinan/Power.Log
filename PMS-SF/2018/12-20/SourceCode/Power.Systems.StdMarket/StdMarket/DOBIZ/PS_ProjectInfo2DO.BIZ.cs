 ...
 namespace  Power.Systems.StdMarket.StdMarket
{
    ...
    /// 前期项目跟踪
    /// </summary>
    public class PS_ProjectInfo2DO : PS_ProjectInfo2DO<PS_ProjectInfo2DO>
    {
    ...
    /// 前期项目跟踪
    /// </summary>
	  [BindEntity(KeyWord="PS_ProjectInfo2",EntityType = typeof(Power.Systems.StdMarket.StdMarket.PS_ProjectInfo2DO),Description = "前期项目跟踪"  )] 
    ...
    public   class PS_ProjectInfo2DO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdMarket.StdMarket.PS_ProjectInfo2DO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 
 /// </summary>
 [BindColumn(2,"a", "SaleClue_Guid", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 项目简称
 /// </summary>
 [BindColumn(5,"a", "ProjectShortName", "项目简称","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 信息来源
 /// </summary>
 [BindColumn(6,"a", "InfoSources", "信息来源","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 项目类型
 /// </summary>
 [BindColumn(7,"a", "ProjectType", "项目类型","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 项目区域
 /// </summary>
 [BindColumn(10,"a", "ProjectArea", "项目区域","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 产品类型
 /// </summary>
 [BindColumn(11,"a", "ProductType", "产品类型","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 招标形式
 /// </summary>
 [BindColumn(14,"a", "TenderType", "招标形式","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 合同形式
 /// </summary>
 [BindColumn(15,"a", "ContractType", "合同形式","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 币种
 /// </summary>
 [BindColumn(17,"a", "CurrencyType", "币种","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(18,"a", "Client_Guid", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(19,"a", "FollowHumanId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 跟进人员
 /// </summary>
 [BindColumn(20,"a", "FollowHuman", "跟进人员","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 
 /// </summary>
 [BindColumn(22,"a", "FollowDeptId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(23,"a", "UpdHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(24,"a", "UpdHuman", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(25,"a", "UpdDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(26,"a", "RegDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(27,"a", "RegHumName", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(28,"a", "RegHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(29,"a", "OwnProjId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(30,"a", "EpsProjId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(31,"a", "ApprHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(32,"a", "ApprHumName", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(33,"a", "ApprDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(34,"a", "Status", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(35,"a", "OwnProjName", "","", "NCHAR", 255,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =255 )]
 ...
 /// 
 /// </summary>
 [BindColumn(36,"a", "FollowStatus", "","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 
 /// </summary>
 [BindColumn(37,"a", "isPrequalification", "","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(38,"a", "PrequalificationDeadline", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(39,"a", "FollowLevel", "","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 
 /// </summary>
 [BindColumn(40,"a", "isFollow", "","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 状态（跟踪用）
 /// </summary>
 [BindColumn(41,"a", "Status2", "状态（跟踪用）","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
