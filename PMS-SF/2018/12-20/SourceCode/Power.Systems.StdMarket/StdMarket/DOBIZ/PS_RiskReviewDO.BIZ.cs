 ...
 namespace  Power.Systems.StdMarket.StdMarket
{
    ...
    /// 项目风险评估
    /// </summary>
    public class PS_RiskReviewDO : PS_RiskReviewDO<PS_RiskReviewDO>
    {
    ...
    /// 项目风险评估
    /// </summary>
	  [BindEntity(KeyWord="PS_RiskReview",EntityType = typeof(Power.Systems.StdMarket.StdMarket.PS_RiskReviewDO),Description = "项目风险评估"  )] 

	 [BindTable( "PS_MK_RiskReview", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PS_MK_RiskReview", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PS_MK_RiskReview",Description="")]

    public   class PS_RiskReviewDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdMarket.StdMarket.PS_RiskReviewDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 
 /// </summary>
 [BindColumn(2,"a", "ProjectInfoId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(3,"a", "UpdHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(4,"a", "UpdHuman", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(5,"a", "UpdDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(6,"a", "RegDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(7,"a", "RegHumName", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(8,"a", "RegHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(9,"a", "OwnProjName", "","", "NCHAR", 255,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =255 )]
 ...
 /// 
 /// </summary>
 [BindColumn(10,"a", "OwnProjId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(11,"a", "EpsProjId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(12,"a", "ApprHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(13,"a", "ApprHumName", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(14,"a", "ApprDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(15,"a", "Status", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(16,"a", "Title", "","", "NCHAR", 100,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =100 )]
