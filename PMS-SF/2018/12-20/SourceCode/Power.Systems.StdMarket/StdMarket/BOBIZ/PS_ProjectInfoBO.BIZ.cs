...
{  
    ...
    /// 前期项目信息
    /// </summary>
    [BindBusinessObject(KeyWord="PS_ProjectInfo",EntityType = typeof(Power.Systems.StdMarket.StdMarket.PS_ProjectInfoDO),BusinessType=Power.Business.Attributes.EBusinessType.Main ,Description = "前期项目信息" ,DefaultBindWorkFlow = true)] 
    public partial  class PS_ProjectInfoBO : PS_ProjectInfoBO<PS_ProjectInfoBO >
    {
    ...
    /// 前期项目信息
    /// </summary>  
	public    partial class PS_ProjectInfoBO<TBusiness> : Power.Business.BaseBusiness<TBusiness>, Power.Systems.StdMarket.IStdMarket.IPS_ProjectInfoBO 
        where TBusiness : Power.Systems.StdMarket.IStdMarket.IPS_ProjectInfoBO, new()
...
/// 是否资格预审
/// </summary>
[BindProperty(Description = "是否资格预审")]
...
/// 资格预审截至日期
/// </summary>
[BindProperty(Description = "资格预审截至日期")]
...
/// 线索GUId
/// </summary>
[BindProperty(Description = "线索GUId")]
...
/// 预计合同形式
/// </summary>
[BindProperty(Description = "预计合同形式")]
...
/// 跟进人Id
/// </summary>
[BindProperty(Description = "跟进人Id")]
...
/// 跟进人名称
/// </summary>
[BindProperty(Description = "跟进人名称")]
...
{  
    ...
    /// 前期项目信息对象接口
    /// </summary>
    public partial interface IPS_ProjectInfoBO :  Power.Business.IBaseBusiness
    {
	      #region 属性 
