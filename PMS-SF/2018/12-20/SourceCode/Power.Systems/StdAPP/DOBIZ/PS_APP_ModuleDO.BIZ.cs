 ...
 namespace  Power.Systems.StdAPP
{
    ...
    /// APP功能模块
    /// </summary>
    public class PS_APP_ModuleDO : PS_APP_ModuleDO<PS_APP_ModuleDO>
    {
    ...
    /// APP功能模块
    /// </summary>
	  [BindEntity(KeyWord="PS_APP_Module",EntityType = typeof(Power.Systems.StdAPP.PS_APP_ModuleDO),Description = "APP功能模块"  )] 

	 [BindTable( "PS_APP_Module", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PS_APP_Module", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PS_APP_Module",Description="")]

    public   class PS_APP_ModuleDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdAPP.PS_APP_ModuleDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 公告标题
 /// </summary>
 [BindColumn(2,"a", "ModuleName", "公告标题","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
 public  System.String ModuleName  { get { return _ModuleName; } set { _ModuleName = value; } }

 private System.String _ModuleIcon;
 /// <summary>
 /// 模块图标
 /// </summary>
 [BindColumn(3,"a", "ModuleIcon", "模块图标","", "NCHAR", 2000,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =2000 )]
 public  System.String ModuleIcon  { get { return _ModuleIcon; } set { _ModuleIcon = value; } }

 private System.String _ModuleLink;
 /// <summary>
 /// 模块链接
 /// </summary>
 [BindColumn(4,"a", "ModuleLink", "模块链接","", "NCHAR", 2000,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =2000 )]
 public  System.String ModuleLink  { get { return _ModuleLink; } set { _ModuleLink = value; } }
 ...
 /// 启用标识
 /// </summary>
 [BindColumn(23,"a", "IsUsed", "启用标识","", "NCHAR", 1,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =1 )]
...
if (name == "MODULEICON")
{
 _ModuleIcon = System.Convert.ToString(value);return;
}
if (name == "MODULELINK")
{
 _ModuleLink = System.Convert.ToString(value);return;
}
if (name == "SEQU")
{
