 ...
 namespace  Power.Systems.StdAPP
{
    ...
    /// APP工程图片
    /// </summary>
    public class PS_APP_ProjectPictureDO : PS_APP_ProjectPictureDO<PS_APP_ProjectPictureDO>
    {
    ...
    /// APP工程图片
    /// </summary>
	  [BindEntity(KeyWord="PS_APP_ProjectPicture",EntityType = typeof(Power.Systems.StdAPP.PS_APP_ProjectPictureDO),Description = "APP工程图片"  )] 

	 [BindTable( "PS_APP_ProjectPicture", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PS_APP_ProjectPicture", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PS_APP_ProjectPicture",Description="")]

    public   class PS_APP_ProjectPictureDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdAPP.PS_APP_ProjectPictureDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 请假人
 /// </summary>
 [BindColumn(2,"a", "PictureUrl", "请假人","", "NCHAR", 500,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =500 )]
 public  System.String PictureUrl  { get { return _PictureUrl; } set { _PictureUrl = value; } }
 ...
 /// </summary>
 [BindColumn(4,"a", "Status", "表单状态；0新增，20审批中，35生效，40终止，50批准","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 录入人Id
 /// </summary>
 [BindColumn(5,"a", "RegHumId", "录入人Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 录入人名称
 /// </summary>
 [BindColumn(6,"a", "RegHumName", "录入人名称","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
 ...
 /// 录入人岗位Id
 /// </summary>
 [BindColumn(8,"a", "RegPosiId", "录入人岗位Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 录入人部门Id
 /// </summary>
 [BindColumn(9,"a", "RegDeptId", "录入人部门Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 记录所属EPS节点Id
 /// </summary>
 [BindColumn(10,"a", "EpsProjId", "记录所属EPS节点Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 删除人Id
 /// </summary>
 [BindColumn(11,"a", "RecycleHumId", "删除人Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 最后更新人Id
 /// </summary>
 [BindColumn(12,"a", "UpdHumId", "最后更新人Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 最后更新人名称
 /// </summary>
 [BindColumn(13,"a", "UpdHumName", "最后更新人名称","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 最后更新日期
 /// </summary>
 [BindColumn(14,"a", "UpdDate", "最后更新日期","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 批准人Id
 /// </summary>
 [BindColumn(15,"a", "ApprHumId", "批准人Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 批准人名称
 /// </summary>
 [BindColumn(16,"a", "ApprHumName", "批准人名称","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 批准日期
 /// </summary>
 [BindColumn(17,"a", "ApprDate", "批准日期","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 备注
 /// </summary>
 [BindColumn(18,"a", "Memo", "备注","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
 ...
 /// 所属项目Id
 /// </summary>
 [BindColumn(19,"a", "OwnProjId", "所属项目Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 所属项目名称
 /// </summary>
 [BindColumn(20,"a", "OwnProjName", "所属项目名称","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
...
if (name == "PICTUREURL")
{
 _PictureUrl = System.Convert.ToString(value);return;
}
if (name == "SEQU")
{
