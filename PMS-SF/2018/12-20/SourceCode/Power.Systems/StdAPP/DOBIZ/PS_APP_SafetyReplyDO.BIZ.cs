 ...
 namespace  Power.Systems.StdAPP
{
    ...
    /// APP安全回复
    /// </summary>
    public class PS_APP_SafetyReplyDO : PS_APP_SafetyReplyDO<PS_APP_SafetyReplyDO>
    {
    ...
    /// APP安全回复
    /// </summary>
	  [BindEntity(KeyWord="PS_APP_SafetyReply",EntityType = typeof(Power.Systems.StdAPP.PS_APP_SafetyReplyDO),Description = "APP安全回复"  )] 

	 [BindTable( "PS_APP_SafetyReply", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PS_APP_SafetyReply", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PS_APP_SafetyReply",Description="")]

    public   class PS_APP_SafetyReplyDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdAPP.PS_APP_SafetyReplyDO<TEntity>, new()
    { 
	    #region 属性
