 ...
 namespace  Power.Systems.StdAPP
{
    ...
    /// APP安全
    /// </summary>
    public class PS_APP_SafetyDO : PS_APP_SafetyDO<PS_APP_SafetyDO>
    {
    ...
    /// APP安全
    /// </summary>
	  [BindEntity(KeyWord="PS_APP_Safety",EntityType = typeof(Power.Systems.StdAPP.PS_APP_SafetyDO),Description = "APP安全"  )] 

	 [BindTable( "PS_APP_Safety", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PS_APP_Safety", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PS_APP_Safety",Description="")]

    public   class PS_APP_SafetyDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdAPP.PS_APP_SafetyDO<TEntity>, new()
    { 
	    #region 属性
