 ...
 namespace  Power.Systems.Systems
{
    ...
    /// 文档分类
    /// </summary>
    public class DocDBSDO : DocDBSDO<DocDBSDO>
    {
    ...
    /// 文档分类
    /// </summary>
	  [BindEntity(KeyWord="DocDBS",EntityType = typeof(Power.Systems.Systems.DocDBSDO),Description = "文档分类"  )] 

	 [BindTable( "PB_DocDBS", Alias = "a",IsAttach=false,Description ="")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="")]

	  [BindIndex(Name = "pk_PB_DocDBS", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_DocDBS",Description="")]
 ...
 [BindIndex(Name = "pt_PB_DocDBS", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PB_DocDBS",Description="")]

    public   class DocDBSDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.Systems.DocDBSDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 父编号
 /// </summary>
 [BindColumn(2,"a", "ParentId", "父编号","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 编码
 /// </summary>
 [BindColumn(3,"a", "Code", "编码","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
