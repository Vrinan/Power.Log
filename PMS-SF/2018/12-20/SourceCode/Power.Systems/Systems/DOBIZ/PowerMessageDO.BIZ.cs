...
{
    /// <summary>
    /// 系统消息（包括系统消息、邮件、通知、警告等）
    /// </summary>
    public class PowerMessageDO : PowerMessageDO<PowerMessageDO>
    {
    ...
    /// 系统消息（包括系统消息、邮件、通知、警告等）
    /// </summary>
	  [BindEntity(KeyWord="PowerMessage",EntityType = typeof(Power.Systems.Systems.PowerMessageDO),Description = "系统消息（包括系统消息、邮件、通知、警告等）"  )] 

	 [BindTable( "PB_Messages", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PB_Messages", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_Messages",Description="")]

    public   class PowerMessageDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.Systems.PowerMessageDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "IsRTX", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 ...
 /// 标题
 /// </summary>
 [BindColumn(2,"a", "Title", "标题","", "NCHAR", 254,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =254 )]
 ...
 /// 到达日期
 /// </summary>
 [BindColumn(3,"a", "ComeDate", "到达日期","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 发送日期
 /// </summary>
 [BindColumn(4,"a", "FromDate", "发送日期","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 消息图标
 /// </summary>
 [BindColumn(5,"a", "Icon", "消息图标","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 接收人编号
 /// </summary>
 [BindColumn(6,"a", "ToHumanId", "接收人编号","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 接收人
 /// </summary>
 [BindColumn(7,"a", "ToHumanName", "接收人","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 发送人编号
 /// </summary>
 [BindColumn(8,"a", "FromHumanId", "发送人编号","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 发送人
 /// </summary>
 [BindColumn(9,"a", "FromHumanName", "发送人","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 public  System.String FromHumanName  { get { return _FromHumanName; } set { _FromHumanName = value; } }

 private System.String _MessageType;
 /// <summary>
 /// 消息类型（通知 notify、消息message、任务事项 task、警告warn、工作流 workflow、其他other）
 /// </summary>
 [BindColumn(10,"a", "MessageType", "消息类型（通知 notify、消息message、任务事项 task、警告warn、工作流 workflow、其他other）","", "NCHAR", 20,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =20 )]
 ...
 /// </summary>
 [BindColumn(11,"a", "GroupId", "消息分组（建议输入GUID，当同一个消息需要发送发送一批消息的时候必填，流程中建议填写节点GUID）","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 工作流消息，记录对应的KeyWord
 /// </summary>
 [BindColumn(11,"a", "KeyWord", "工作流消息，记录对应的KeyWord","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 工作流消息，记录对应的KeyValue
 /// </summary>
 [BindColumn(12,"a", "KeyValue", "工作流消息，记录对应的KeyValue","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// </summary>
 [BindColumn(13,"a", "IsMail", "是否发送邮件（0 否；1 表示是；2表示已发送；3用户已处理）","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 ...
 /// </summary>
 [BindColumn(14,"a", "IsTextMessage", "是否发送短信（0 否；1 表示是；2表示已发送；3用户已处理）","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 ...
 /// </summary>
 [BindColumn(15,"a", "IsPowerMessage", "是否发送系统消息（0 否；1 表示是；2表示已发送；3用户已处理）","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 ...
 /// </summary>
 [BindColumn(16,"a", "IsDeviceMessage", "是否根据设备特性推送消息（0 否；1 表示是；2表示已发送；3用户已处理）","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 ...
 /// 消息内容
 /// </summary>
 [BindColumn(17,"a", "ContentText", "消息内容","", "NCHAR", 500,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =500 )]
 ...
 /// 
 /// </summary>
 [BindColumn(18,"a", "CronExpress", "","", "NCHAR", 100,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =100 )]
 ...
 /// </summary>
 [BindColumn(19,"a", "IsSend", "是否发送完毕(0否,1是)，其他几个状态的与结果","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(20,"a", "FormId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 项目Id
 /// </summary>
 [BindColumn(22,"a", "EpsProjId", "项目Id","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 项目编号
 /// </summary>
 [BindColumn(23,"a", "EpsProjCode", "项目编号","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 项目名称
 /// </summary>
 [BindColumn(24,"a", "EpsProjName", "项目名称","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
