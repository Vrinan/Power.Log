 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 专业
    /// </summary>
    public class MajorDO : MajorDO<MajorDO>
    {
    ...
    /// 专业
    /// </summary>
	  [BindEntity(KeyWord="Major",EntityType = typeof(Power.Systems.StdSystem.MajorDO),Description = "专业"  )] 

	 [BindTable( "PB_Major", Alias = "a",IsAttach=false,Description ="")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="")]

	  [BindIndex(Name = "pk_PB_Major", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_Major",Description="")]
 ...
 [BindIndex(Name = "pt_PB_Major", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PB_Major",Description="")]

    public   class MajorDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.MajorDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 简称
 /// </summary>
 [BindColumn(5,"a", "ShortName", "简称","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 public  System.String ShortName  { get { return _ShortName; } set { _ShortName = value; } }

 private System.SByte _MajorType;
 /// <summary>
 /// 1是专业，0是分类
 /// </summary>
 [BindColumn(6,"a", "MajorType", "1是专业，0是分类","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 public  System.SByte MajorType  { get { return _MajorType; } set { _MajorType = value; } }

 private System.SByte _Actived;
 /// <summary>
 /// 1有效，0无效
 /// </summary>
 [BindColumn(7,"a", "Actived", "1有效，0无效","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =3 )]
 ...
 /// 长代码
 /// </summary>
 [BindColumn(8,"a", "LongCode", "长代码","", "NCHAR", 1000,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =1000 )]
...
if (name == "MAJORTYPE")
{
 _MajorType = System.Convert.ToSByte(value);return;
}
if (name == "ACTIVED")
{
