 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 组织单位(PB_Organize)
    /// </summary>
    public class OrganizeDO : OrganizeDO<OrganizeDO>
    {
    ...
    /// 组织单位(PB_Organize)
    /// </summary>
	  [BindEntity(KeyWord="Organize",EntityType = typeof(Power.Systems.StdSystem.OrganizeDO),Description = "组织单位(PB_Organize)"  )] 

	 [BindTable( "PB_Organize", Alias = "a",IsAttach=false,Description ="组织单位")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="常用字段")]

	  [BindIndex(Name = "pk_PB_Organize", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_Organize",Description="组织单位")]
 ...
 [BindIndex(Name = "pt_PB_Organize", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PB_Organize",Description="组织单位")]

    public   class OrganizeDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.OrganizeDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 原始单位Id
 /// </summary>
 [BindColumn(1,"a", "SourceOrganizeId", "原始单位Id","", "NCHAR", 0,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =0 )]
 ...
 /// Y是长名单，N不是
 /// </summary>
 [BindColumn(1,"a", "IsLongList", "Y是长名单，N不是","", "NCHAR", 6,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =6 )]
 ...
 private System.String _ValidStatus;
 /// <summary>
 /// 评价状态
 /// </summary>
 [BindColumn(1,"a", "ValidStatus", "评价状态","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =50 )]
 public  System.String ValidStatus  { get { return _ValidStatus; } set { _ValidStatus = value; } }
 ...
 /// 电话
 /// </summary>
 [BindColumn(10,"a", "Phone", "电话","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 开户银行账号
 /// </summary>
 [BindColumn(18,"a", "BankAccount", "开户银行账号","", "NCHAR", 30,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =30 )]
...
if (name == "VALIDSTATUS")
{
 _ValidStatus = System.Convert.ToString(value);return;
}
if (name == "PARENTID")
{
