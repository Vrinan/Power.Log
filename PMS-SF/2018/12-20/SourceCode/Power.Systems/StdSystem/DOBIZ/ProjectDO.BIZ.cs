 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 项目
    /// </summary>
    public class ProjectDO : ProjectDO<ProjectDO>
    {
    ...
    /// 项目
    /// </summary>
	  [BindEntity(KeyWord="Project",EntityType = typeof(Power.Systems.StdSystem.ProjectDO),Description = "项目"  )] 
 ...
 [BindIndex(Name = "pt_PLN_project", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "parent_guid,project_guid", TableName = "PLN_project",Description="")]
    ...
    public   class ProjectDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.ProjectDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// </summary>
 [BindColumn(1,"a", "EpsProjType", "管理层级类型；0非管理层级，1总公司，2分公司，3项目群，4项目...","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "Pro_owners_name", "","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
 ...
 /// 经度
 /// </summary>
 [BindColumn(1,"a", "Longitude", "经度","", "NCHAR", 18,7,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =18 )]
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "Pro_manager_name", "","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "Pro_manager_guid", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 管理层级名称
 /// </summary>
 [BindColumn(1,"a", "EpsProjName", "管理层级名称","", "NCHAR", 255,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =255 )]
 ...
 ///  管理层级Id
 /// </summary>
 [BindColumn(1,"a", "EpsProjId", " 管理层级Id","", "NCHAR", 38,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =38 )]
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "Pro_owners_guid", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 纬度
 /// </summary>
 [BindColumn(1,"a", "Latitude", "纬度","", "NCHAR", 18,7,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =18 )]
 ...
 /// 国家
 /// </summary>
 [BindColumn(80,"a", "Country", "国家","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =200 )]
 ...
 /// 省
 /// </summary>
 [BindColumn(81,"a", "Province", "省","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =200 )]
 public  System.String Province  { get { return _Province; } set { _Province = value; } }

 private System.String _City;
 /// <summary>
 /// 市
 /// </summary>
 [BindColumn(82,"a", "City", "市","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =200 )]
 public  System.String City  { get { return _City; } set { _City = value; } }

 private System.String _County;
 /// <summary>
 /// 县
 /// </summary>
 [BindColumn(83,"a", "County", "县","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =200 )]
 public  System.String County  { get { return _County; } set { _County = value; } }

 private System.String _EpsProjIcon;
 /// <summary>
 /// 
 /// </summary>
 [BindColumn(84,"a", "EpsProjIcon", "","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
 public  System.String EpsProjIcon  { get { return _EpsProjIcon; } set { _EpsProjIcon = value; } }

 private System.String _EspProjIcon;
 /// <summary>
 /// 
 /// </summary>
 [BindColumn(84,"a", "EspProjIcon", "","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
 public  System.String EspProjIcon  { get { return _EspProjIcon; } set { _EspProjIcon = value; } }
...
if (name == "COUNTRY")
{
 _Country = System.Convert.ToString(value);return;
}
if (name == "PROVINCE")
{
 _Province = System.Convert.ToString(value);return;
}
if (name == "CITY")
{
 _City = System.Convert.ToString(value);return;
}
if (name == "COUNTY")
{
 _County = System.Convert.ToString(value);return;
}
if (name == "EPSPROJICON")
{
 _EpsProjIcon = System.Convert.ToString(value);return;
}
if (name == "ESPPROJICON")
{
 _EspProjIcon = System.Convert.ToString(value);return;
}
