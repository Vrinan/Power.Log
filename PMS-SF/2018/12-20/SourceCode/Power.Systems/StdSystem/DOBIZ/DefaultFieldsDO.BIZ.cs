 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 默认公共字段
    /// </summary>
    public class DefaultFieldsDO : DefaultFieldsDO<DefaultFieldsDO>
    {
    ...
    /// 默认公共字段
    /// </summary>
	  [BindEntity(KeyWord="DefaultFields",EntityType = typeof(Power.Systems.StdSystem.DefaultFieldsDO),Description = "默认公共字段"  )] 

	 
	 
    public  abstract class DefaultFieldsDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.DefaultFieldsDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 管理层级名称
 /// </summary>
 [BindColumn(21,"a", "OwnProjName", "管理层级名称","", "NCHAR", 255,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =255 )]
