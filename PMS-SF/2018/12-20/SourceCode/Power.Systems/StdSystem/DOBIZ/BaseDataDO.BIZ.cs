 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 基础数据
    /// </summary>
    public class BaseDataDO : BaseDataDO<BaseDataDO>
    {
    ...
    /// 基础数据
    /// </summary>
	  [BindEntity(KeyWord="BaseData",EntityType = typeof(Power.Systems.StdSystem.BaseDataDO),Description = "基础数据"  )] 

	 [BindTable( "PB_BaseData", Alias = "a",IsAttach=false,Description ="")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="")]

	  [BindIndex(Name = "pk_PB_BaseData", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_BaseData",Description="")]
 [BindIndex(Name = "pk_PB_DefaultField", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "DefaultFieldId", TableName = "PB_DefaultField",Description="")]
    ...
    public   class BaseDataDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.BaseDataDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// Global/Project
 /// </summary>
 [BindColumn(1,"a", "UseRange", "Global/Project","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "bSysDefault", "","", "NCHAR", 1,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =1 )]
 ...
 /// Y允许维护
 /// </summary>
 [BindColumn(1,"a", "bAllowEdit", "Y允许维护","", "NCHAR", 1,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =1 )]
 ...
 /// 名称
 /// </summary>
 [BindColumn(2,"a", "Name", "名称","", "NCHAR", 100,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =100 )]
 ...
 /// 类型
 /// </summary>
 [BindColumn(3,"a", "DataType", "类型","", "NCHAR", 15,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =15 )]
 public  System.String DataType  { get { return _DataType; } set { _DataType = value; } }
...
if (name == "DATATYPE")
{
 _DataType = System.Convert.ToString(value);return;
}
if (name == "TABLENAME")
{
