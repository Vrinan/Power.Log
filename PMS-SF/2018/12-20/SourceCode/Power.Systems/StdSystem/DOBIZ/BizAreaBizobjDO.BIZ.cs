 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 业务对象1
    /// </summary>
    public class BizAreaBizobjDO : BizAreaBizobjDO<BizAreaBizobjDO>
    {
    ...
    /// 业务对象1
    /// </summary>
	  [BindEntity(KeyWord="BizAreaBizobj",EntityType = typeof(Power.Systems.StdSystem.BizAreaBizobjDO),Description = "业务对象1"  )] 
 ...
 [BindIndex(Name = "pt_PB_BizAreaObject", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PB_BizAreaObject",Description="")]
    ...
    public   class BizAreaBizobjDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.BizAreaBizobjDO<TEntity>, new()
    { 
	    #region 属性
