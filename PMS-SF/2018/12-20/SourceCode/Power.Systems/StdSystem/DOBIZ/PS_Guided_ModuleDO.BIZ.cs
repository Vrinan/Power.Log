 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 引导式模块
    /// </summary>
    public class PS_Guided_ModuleDO : PS_Guided_ModuleDO<PS_Guided_ModuleDO>
    {
    ...
    /// 引导式模块
    /// </summary>
	  [BindEntity(KeyWord="PS_Guided_Module",EntityType = typeof(Power.Systems.StdSystem.PS_Guided_ModuleDO),Description = "引导式模块"  )] 

	 [BindTable( "PS_Guided_Module", Alias = "a",IsAttach=false,Description ="")]

	  [BindIndex(Name = "pk_PS_Guided_Module", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "ModuleId", TableName = "PS_Guided_Module",Description="")]

    public   class PS_Guided_ModuleDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.PS_Guided_ModuleDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 
 /// </summary>
 [BindColumn(1,"a", "ModuleId", "","", "NCHAR", 16,0,false, IsPrimaryKey =true ,IsIdentity =true,IsNullable =false,  Length =16 )]
 public virtual System.Guid ModuleId  { get { return _ModuleId; } set { _ModuleId = value; } }
 ...
 /// 
 /// </summary>
 [BindColumn(3,"a", "ModuleName", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(4,"a", "IsDefault", "","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(5,"a", "IsEnable", "","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(6,"a", "BizAreaId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(7,"a", "Sequ", "","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(8,"a", "Status", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(9,"a", "RegHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(11,"a", "RegDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(12,"a", "RegPosiId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(13,"a", "RegDeptId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(15,"a", "RecycleHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(16,"a", "UpdHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(17,"a", "UpdHuman", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(18,"a", "UpdDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(19,"a", "ApprHumId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(20,"a", "ApprHumName", "","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(21,"a", "ApprDate", "","", "NCHAR", 3,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =3 )]
 ...
 /// 
 /// </summary>
 [BindColumn(22,"a", "OwnProjName", "","", "NCHAR", 255,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =255 )]
 ...
 /// 
 /// </summary>
 [BindColumn(23,"a", "OwnProjId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 /// 
 /// </summary>
 [BindColumn(24,"a", "Memo", "","", "NCHAR", 1000,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =1000 )]
 ...
 /// 
 /// </summary>
 [BindColumn(25,"a", "MenuName", "","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
