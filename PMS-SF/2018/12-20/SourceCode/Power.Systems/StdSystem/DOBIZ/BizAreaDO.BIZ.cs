 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 业务域(PB_BizArea)
    /// </summary>
    public class BizAreaDO : BizAreaDO<BizAreaDO>
    {
    ...
    /// 业务域(PB_BizArea)
    /// </summary>
	  [BindEntity(KeyWord="BizArea",EntityType = typeof(Power.Systems.StdSystem.BizAreaDO),Description = "业务域(PB_BizArea)"  )] 

	 [BindTable( "PB_BizArea", Alias = "a",IsAttach=false,Description ="业务域")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="常用字段")]

	  [BindIndex(Name = "pk_PB_BizArea", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_BizArea",Description="业务域")]
 ...
 [BindIndex(Name = "pt_PB_BizArea", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PB_BizArea",Description="业务域")]

    public   class BizAreaDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.BizAreaDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 名称
 /// </summary>
 [BindColumn(1,"a", "Name", "名称","", "NCHAR", 80,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =80 )]
 ...
 /// 
 /// </summary>
 [BindColumn(2,"a", "Id", "","", "NCHAR", 16,0,false, IsPrimaryKey =true ,IsIdentity =true,IsNullable =false,  Length =16 )]
 ...
 /// 编号
 /// </summary>
 [BindColumn(3,"a", "Code", "编号","", "NCHAR", 10,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =10 )]
 ...
 /// 
 /// </summary>
 [BindColumn(3,"a", "ParentId", "","", "NCHAR", 16,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =16 )]
 ...
 public  System.Guid EpsId  { get { return _EpsId; } set { _EpsId = value; } }
...
if (name == "EPSID")
{
 _EpsId = XCode.Common.Helper.ConvertToGuid(value);return;
}
if (name == "RECYCLEHUMID")
{
