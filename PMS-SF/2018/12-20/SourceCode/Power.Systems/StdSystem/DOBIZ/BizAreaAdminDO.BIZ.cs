 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// 管理员
    /// </summary>
    public class BizAreaAdminDO : BizAreaAdminDO<BizAreaAdminDO>
    {
    ...
    /// 管理员
    /// </summary>
	  [BindEntity(KeyWord="BizAreaAdmin",EntityType = typeof(Power.Systems.StdSystem.BizAreaAdminDO),Description = "管理员"  )] 
    ...
    public   class BizAreaAdminDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.BizAreaAdminDO<TEntity>, new()
    { 
	    #region 属性
