 ...
 namespace  Power.Systems.StdSystem
{
    ...
    /// Department
    /// </summary>
    public class DepartmentDO : DepartmentDO<DepartmentDO>
    {
    ...
    /// Department
    /// </summary>
	  [BindEntity(KeyWord="Department",EntityType = typeof(Power.Systems.StdSystem.DepartmentDO),Description = "Department"  )] 

	 [BindTable( "PB_Department", Alias = "a",IsAttach=false,Description ="")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="")]

	  [BindIndex(Name = "pk_PB_Department", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PB_Department",Description="")]
 ...
 [BindIndex(Name = "pt_PB_Department", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PB_Department",Description="")]

    public   class DepartmentDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdSystem.DepartmentDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 名称
 /// </summary>
 [BindColumn(4,"a", "Name", "名称","", "NCHAR", 50,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =50 )]
 ...
 /// 基础部门Id
 /// </summary>
 [BindColumn(1,"b", "BaseDataId", "基础部门Id","", "NCHAR", 0,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =0 )]
 ...
 /// 基础部门
 /// </summary>
 [BindColumn(1,"b", "BaseDataName", "基础部门","", "NCHAR", 100,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =false,  Length =100 )]
