 ...
 namespace  Power.Systems.StdKM.StdKM
{
    ...
    /// 企业知识分类
    /// </summary>
    public class PS_KM_DocFolderDO : PS_KM_DocFolderDO<PS_KM_DocFolderDO>
    {
    ...
    /// 企业知识分类
    /// </summary>
	  [BindEntity(KeyWord="PS_KM_DocFolder",EntityType = typeof(Power.Systems.StdKM.StdKM.PS_KM_DocFolderDO),Description = "企业知识分类"  )] 

	 [BindTable( "PS_KM_DocFolder", Alias = "a",IsAttach=false,Description ="")]
[BindTable( "PB_DefaultField", Alias = "b",IsAttach=true,Description ="")]

	  [BindIndex(Name = "pk_PS_KM_DocFolder", KeyType = Power.DataAccessLayer.KeyType.MainKey, Columns = "Id", TableName = "PS_KM_DocFolder",Description="")]
 ...
 [BindIndex(Name = "pt_PS_KM_DocFolder", KeyType = Power.DataAccessLayer.KeyType.ParentKey, Columns = "ParentId,Id", TableName = "PS_KM_DocFolder",Description="")]

    public   class PS_KM_DocFolderDO<TEntity> : XCode.Entity<TEntity>, XCode.IEntity where TEntity : Power.Systems.StdKM.StdKM.PS_KM_DocFolderDO<TEntity>, new()
    { 
	    #region 属性
 ...
 /// 
 /// </summary>
 [BindColumn(6,"a", "LongCode", "","", "NCHAR", 200,0,false, IsPrimaryKey =false ,IsIdentity =false,IsNullable =true,  Length =200 )]
