alter proc P_SF_ReturnOutContract(@BeginDate nvarchar(200),@EndDate nvarchar(200))
as
...
from pln_project where pln_project.project_guid in(select id from dbo.[returnEPSChildrenTreeIds]('4b5d4678-5f00-4eb6-b14d-61e6bfc01674')) order by LongCode
end
