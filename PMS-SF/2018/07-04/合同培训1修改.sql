...
AS
SELECT Id,MasterId,Sequ,PayNodes,CheckAmount,(SELECT Name FROM dbo.PB_BaseDataList b WHERE BaseDataId='30688728-C323-44EE-876B-C4E94F264CB6' AND Code=a.PayType) PayType,PayAmount FROM PS_MK_ContractInfo_PayNodes a


select* from V_SF_HT_ContractInfo_PayNodes where 1=1 and MasterId='0925EFEE-4D1F-4145-B25C-C0FA77E7AB5A' and CheckAmount <> 0
and Id not in(SELECT PayNodes_Guid FROM PS_CM_ContractApplyMoney_Nodes b WHERE b.MasterId='1D0C7B9E-C331-4827-85CE-B26FEE41F920')
