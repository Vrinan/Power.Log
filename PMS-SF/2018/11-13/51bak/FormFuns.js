...
var FormFuns = function () {
    ...
    return funsself = {
        ...
        LoadRight: function (miniid, bchild) {
            ...
            if($("#zyxReturnBtn").length==0 && formstate!="add"){
                ...
                if(sessiondata.HumanId=="ad000000-0000-0000-0000-000000000000"
                   ||( (config.KeyWord=="PS_SubContract"||config.KeyWord=="PS_SubContract_PiClass") && sessiondata.HumanId=="876E32AF-118E-42E7-BC51-6F53272738CE".toLowerCase()) 
        ...
        AlExportDataToXls: function (gridid, filename, MergeColumns, groupfield, fnonbeforeload, headercolor, headerfontcolor, exporttype) {
            ...
            //var mergeColumns = (MergeColumns && MergeColumns.length > 0) ? MergeColumns : null;
            //if (mergeColumns)
            //{
            //    var MergeColumns = mergeColumns.split(',');
            //    json.mergeColumns = MergeColumns;
            //}
...
function zyxReturnBtn(KeyWord){
    if(formconfig.FormId&&formconfig.KeyValue){
        ...
        Power.ui.confirm("系统将记录删除人信息，确定执行吗?", function (action) {
            if (action){
                $.ajax({
