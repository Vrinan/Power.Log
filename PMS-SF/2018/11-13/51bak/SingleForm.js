...
var SingleForm = function () {
    ...
    */
    ...
    return singleself = {
        ...
        OnExportDataToXls: function (gridid, filename, groupfield, fnonbeforeload, headercolor, headerfontcolor) {
            FormFuns.ExportDataToXls(gridid, filename, groupfield, fnonbeforeload, headercolor, headerfontcolor);
        },
        OnExportDataToPDF: function (gridid, filename, groupfield, fnonbeforeload, headercolor, headerfontcolor) {
            FormFuns.ExportDataToXls(gridid, filename, groupfield, fnonbeforeload, headercolor, headerfontcolor, 'pdf');
        },
