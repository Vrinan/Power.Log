    ...
    return funsself = {
        ...
        LoadRight: function (miniid, bchild) {
            ...
            if($("#SendTo").length==0 && formstate!="add"){
                ...
                // if(sessiondata.HumanId.toLowerCase()=="ad000000-0000-0000-0000-000000000000" && config.KeyWord=="PS_SubContract_PiClass" &&sessiondata.HumanId=="7F464B4A-D096-4A87-BFCE-BF1A3ACE4285".toLowerCase())
