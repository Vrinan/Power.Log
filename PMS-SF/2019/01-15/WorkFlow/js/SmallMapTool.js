...
SmallMapTool.prototype = {
	...
	drawLine : function (line) {
		...
		if (brokenType != 1) {
			path = tempLineTool.broken(parseInt(headPoint1), parseInt(headPoint2), parseInt(endPoint1), parseInt(endPoint2), brokenType);
		} else {
			path = "M " + parseInt(headPoint1) + " " + parseInt(headPoint2) + " L " + parseInt(endPoint1) + " " + parseInt(endPoint2) + " z";
		}
