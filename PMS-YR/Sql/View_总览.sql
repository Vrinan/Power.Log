...
/****** Object:  View [dbo].[V_PS_Purchase]    Script Date: 2018-2-28 9:00:11 ******/
SET ANSI_NULLS ON
GO
...
select case when bomfile.Status = '20' and b.Request_Code is null then '已发起申请'
when bomfile.Status = '50' and b.Request_Code is null and g.Subcontract_Code is null then '申请已通过'
when b.Request_Status = '20' and c.Order_Code is null and g.Subcontract_Code is null then '已发起请购'
...
when datediff(day, d.Inquiry_CreateDate ,c.Order_RegDate)>9 then '采购审批超期未发'
...
i.MatInStore_Id,i.MatInStore_Status,i.MatInStore_Code,i.MatInStore_CreateDate,i.MatInStore_FinishDate,i.MatInStore_RegDate
